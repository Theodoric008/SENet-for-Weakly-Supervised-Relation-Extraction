...
class DataManager:
    ...
    def load_word2vec(self):
        ...
        self.wordvector_dim = len(wordvector[1])-1
        self.word2index["UNK"] = 0
        self.index2vector.append(np.zeros(self.wordvector_dim))
        index = 1
        for vec in wordvector[1:]:
            ...
            index += 1
        # all_words_list = list(self.word2index.keys())
        # pkl.dump(all_words_list, open("vocab_list.pkl", "wb"))
        # embed()
    ...
    def load_training_data(self, filename="../data/RE/train.txt", distant_supervision=True):
        ...
        for data in training_data:
            ...
            s = Sentence(entity1, entity2, relation, data[5:-1])
